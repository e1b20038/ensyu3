package oit.is.z0484.kaizi.ensyu3.security;
...
public class Sample3AuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails admin = users
        ...
        .roles("ADMIN")
        .build();
    UserDetails gaku = users
        .username("gaku")
        .password("$2y$10$v/Ka1VY2pcbdKg6Eh4dCXe5gWEE8XtyD9wSG86RpYb7h2XKRab9GO")
        .roles("USER")
        .build();
    UserDetails shem = users
        .username("shem")
        .password("$2y$10$.hQd.cOCR42MNyN595XY1.8y/aAhfIL.hq8YJYEdH2.0OUpNH9t6C")
        .roles("SHEM")
        .build();

    // 生成したユーザをImMemoryUserDetailsManagerに渡す（いくつでも良い）
    return new InMemoryUserDetailsManager(user1, user2, admin, gaku, shem);
  }
